import { getAtlasList,addAtlas,updateAtlas,updateStatusByAtlas,getAllCategory,buyImgList } from '@/services/atlas';
...
export default {
  ...
  effects: {
    *fetch({ payload }, { call, put }) {
      const response = yield call(buyImgList, payload);
      yield put({
        type: 'getAtlasList',
        payload: response,
      });
